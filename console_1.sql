...
--#  машина табликанын ичинен толко машинанын брендин жана моделин жана баасын чыгарыныз
select brand, model, price from cars;

--# машина табликасынын ичинен баардык машиналардын санын чыгарабыз
select count(*) from cars;

--#Brendi Hyundaiga барабар болгон баардык машиналарды чыгарабыз
select * from cars where brand ilike ('Hyundai');

--#Баардык Кызыл жана Кок болгон машиналарды чыгарабыз
select * from cars where color ilike ('Red')
or color ilike ('Blue');

--#Баардык 2000 менен 2010чу Жылдары Арасынан чыккан машиналарды чыгарабыз
select * from cars where year_of_issue between 2000 and 2010;

--#Chevrolet брендинде канча машина бар экендигин чыгарабыз
select count(*) from cars where brand ilike 'Chevrolet';

--#Машиналардын жылдарынын орточо мааниси* (средное значение) табыңыз
select avg(year_of_issue) as avg from cars;

--#Audi, Toyota, Kia jana Ford, ушул маркадагы баардык машиналарды чыгаргыла
select * from cars where brand in('Audi', 'Toyota', 'Kia' ,'Ford');

--#Машинанын модели ’Т’ менен башталган машиналарды чыгарабыз#
select *
from cars where model ilike ('t%');

--#Машинанын модели ‘е’ менен аяктаган машиналарды чыгарыңыз
select *
from cars where model ilike ('%e');

--# 5 символ камтыган бренддерди консолго чыгарыныз
select *
from cars where brand ilike ('_____');

--# эн кымбат жана эн арзан машинаны чыгарабыз
select * from cars order by price desc limit 1;
select * from cars order by price asc limit 1;

--#  TOYOTAдан башкасынын баарын чыгарыңыз
select * from cars where brand not ilike ('Toyota') ;


--# Эң кымбат 10 унааны көрсөтүңүз
select *
from cars order by price desc limit 10 ;

--# Эн жаны машиналарды 5тен баштап 15чиге чейнки машиналарды чыгарыныз
select *
from cars where id between 5 and 15  order by year_of_issue desc limit 1 ;

--# 1995 жана 2005 жылдар арасындагы машиналардан башка баардык машиналарды чыгарабыз
select * from cars where year_of_issue not between 1995 and 2005 ;

--# эн коп машинасы бар тусторду корсотунуздор мен канча машинасы бар экениниз дагы коротунуздор
select color, count(*) as models_count from cars group by color order by count(*) desc limit 1;
